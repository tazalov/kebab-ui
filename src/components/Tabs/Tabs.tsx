...
export type RootProps = Omit<ComponentPropsWithoutRef<typeof RadixTabs.Root>, 'asChild'>
...
export type ListProps = Omit<ComponentPropsWithoutRef<typeof RadixTabs.List>, 'asChild'>
...
export type ItemProps = Omit<ComponentPropsWithoutRef<typeof RadixTabs.Trigger>, 'asChild'>
...
export type ContentProps = Omit<ComponentPropsWithoutRef<typeof RadixTabs.Content>, 'asChild'>
